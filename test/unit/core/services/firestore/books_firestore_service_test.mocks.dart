...
// in library_management_system/test/unit/core/services/firestore/books_firestore_service_test.dart.
...
class MockBookCollection extends _i1.Mock
...
/// See the documentation for Mockito's code generation for more information.
// ignore: must_be_immutable
class MockBookDocument extends _i1.Mock
...
/// See the documentation for Mockito's code generation for more information.
// ignore: must_be_immutable
class MockBookQuery extends _i1.Mock
    implements _i4.Query<Map<String, dynamic>> {
  MockBookQuery() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBookQuerySnapshot extends _i1.Mock
    implements _i4.QuerySnapshot<Map<String, dynamic>> {
  MockBookQuerySnapshot() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBookDocumentSnapshot extends _i1.Mock
    implements _i4.DocumentSnapshot<Map<String, dynamic>> {
  MockBookDocumentSnapshot() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBookWriteBatch extends _i1.Mock implements _i4.WriteBatch {
  @override
